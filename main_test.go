...
func TestKeyExpand(t *testing.T) {
	var tests = []struct {
		...
		{
			[]uint32{0xE9DEE72C, 0x8F0C0FA6, 0x2DDB49F4, 0x6F739647},
			key{0xE9DEE72C, 0x8F0C0FA6, 0x2DDB49F4, 0x6F739647, 0xE9DEE72C, 0x8F0C0FA6, 0x2DDB49F4, 0x6F739647},
			nil,
		},
		{
			[]uint32{0xE9DEE72C, 0x8F0C0FA6, 0x2DDB49F4, 0x6F739647, 0x06075316, 0xED247A37},
			key{0xE9DEE72C, 0x8F0C0FA6, 0x2DDB49F4, 0x6F739647, 0x06075316, 0xED247A37, 0x4B09A17E, 0x8450BF66},
			nil,
		},
		{
			[]uint32{0xE9DEE72C, 0x8F0C0FA6, 0x2DDB49F4, 0x6F739647, 0x06075316, 0xED247A37, 0x39CBA383, 0x03A98BF6},
			key{0xE9DEE72C, 0x8F0C0FA6, 0x2DDB49F4, 0x6F739647, 0x06075316, 0xED247A37, 0x39CBA383, 0x03A98BF6},
			nil,
		},
		{
			[]uint32{0xE9DEE72C, 0x8F0C0FA6, 0x2DDB49F4, 0x6F739647, 0x06075316, 0xED247A37, 0x39CBA383},
			key{},
			InvalidKeyLength,
		},
	}
	for _, test := range tests {
		if got, e := KeyExpand(test.t); got != test.key || e != test.err {
			t.Errorf("KeyExpand(%x) is %x, %e, not %x, %e", test.t, test.key, test.err, got, e)
		}
	}
}
